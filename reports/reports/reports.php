	...
	// Create new PHPExcel object
		...
		while ($row = mysql_fetch_array($result))
		{
			...
			if($i == 0)	// Make first worksheet which is the combined report
				...
				$objPHPExcel->setActiveSheetIndex($i)->getStyle('B10:B200')->applyFromArray($left_style);
		...
		$objPHPExcel->setActiveSheetIndex(0)->getStyle($company_c)->applyFromArray($header_style);		
		$objPHPExcel->setActiveSheetIndex(0)->getStyle("A16:D16")->applyFromArray($border_thin);			
		$objPHPExcel->getActiveSheet()->getStyle('B10:B'+$last_row)->getNumberFormat()->setFormatCode('$#,##0.00');
